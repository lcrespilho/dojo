from . import api
from .resources import card, deck, deck_cards, user
...
def define_routes():
    ...
    api.add_resource(deck_cards.DeckCardsDetailView, _base + 'decks/<string:deck_pk>/cards/<string:card_pk>', methods=['GET','POST'])
